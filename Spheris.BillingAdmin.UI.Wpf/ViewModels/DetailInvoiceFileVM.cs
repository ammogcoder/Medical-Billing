...
namespace Spheris.BillingAdmin.UI.Wpf.ViewModels
{
    ...
    public class DetailInvoiceFileVM : ViewModelBase, IDropTarget, IDataErrorInfo
    {
        ...
        {
            Target = Billing.Data.BillingDataFactory.NewInstance().CreateInvoiceDetailRepository();
        ...
        public ReportTypePackage Package
        {
            ...
            set
            {
...
#if CAUSES_A_LOSS_IN_BINDING_YYYY
                    if(value != null)
                        value.ReConstructPackageListFromSql();
#endif
                    OnPropertyChanged("OrderByClause");
                }
                ...
                // They were generating a new item
                if (CreatingNew)
                    return;
                package = value;
